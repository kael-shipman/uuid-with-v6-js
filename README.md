...
This package additionally bundles a command-line scripts, `uuidgen`, which you can use to to generate a uuid of any given flavor. See `npx -p @kael-shipman/uuid-with-v6 uuidgen --help` for details.
